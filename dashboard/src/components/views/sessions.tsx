                                                    ...
                                                    <tr key={i} className="border-b last:border-b-0 align-top">
                                                        <td className="py-2 pr-3">
                                                            <div className="flex items-center gap-2 min-w-0">
                                                                ...
                                                                <span className="truncate text-foreground" title={title || "Untitled tab"}>
                                                                    {title ? (title.length > 50 ? `${title.slice(0, 50)}...` : title) : "Untitled tab"}
                                                                </span>
                                                            </div>
                                                        </td>
                                                        <td className="py-2 pr-3 max-w-[28rem]">
                                                            {url ? (
                                                                <a href={url} target="_blank" rel="noreferrer" className="truncate text-blue-600 hover:underline dark:text-blue-400" title={url}>
